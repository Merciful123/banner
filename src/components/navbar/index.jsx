...
//       <NavbarContent>
//         <p className="font-bold text-inherit">GO FOOD</p>
//       </NavbarContent>

//       <NavbarContent
//         className="hidden sm:flex  gap-4 navbar-child-2 w-full"
//         // justify="between"
//       >
//         {/*  */}
//         <Dropdown className="place-self-end middle-content" id="middle-content">
//           <NavbarItem>
//             <DropdownTrigger>
//               <Button
//                 disableRipple
...
//       <NavbarContent className="flex justify-between left-side basis-2" id="left-side">
//         <NavbarContent
//         //   justify="end"
